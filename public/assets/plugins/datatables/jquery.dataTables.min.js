...
(function (Fa, T, k) {
    var S = function (g) {
        ...
        function ka(a, b, c) {
            ...
            a = -1 !== g.inArray("desc", b.asSorting);
            c = -1 !== g.inArray("asc", b.asSorting);
            !b.bSortable || (!a && !c)
            ...
            for (
                ...
                c.bSortable &&
                    (0 < d.length && d[0].col == f
                        ? (g.setAttribute(
                              "aria-sort",
                              "desc" == d[0].dir ? "descending" : "ascending"
                          ),
                          (c = i[d[0].index + 1] || i[0]))
                        : (c = i[0]),
                    (b += "desc" === c ? a.sSortDescending : a.sSortAscending));
            ...
            iterator: function (a, b, c, e) {
                ...
                for (g = l.length; h < g; h++) {
                    ...
                    if ("table" === b)
                        ...
                        (f = c.call(o, l[h], this[h], h)), f !== k && d.push(f);
                    else if (
                        "column" === b ||
                        "column-rows" === b ||
                        "row" === b ||
